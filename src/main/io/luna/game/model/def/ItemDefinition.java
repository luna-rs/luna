...
public final class ItemDefinition {
     ...
     * @param noteable The flag that determines if this {@code ItemDefinition}
     *        is noteable.
     * @param stackable The flag that determines if this {@code ItemDefinition}
     *        is stackable.
     * @param specialValue The special store value of this
     *        {@code ItemDefinition}.
     * @param generalValue The general store value of this
     *        {@code ItemDefinition}.
     * @param lowAlchValue The low alchemy value of this {@code ItemDefinition}.
     * @param highAlchValue The high alchemy value of this
     *        {@code ItemDefinition}.
     * @param weight The weight value of this {@code ItemDefinition}.
     * @param bonus The array of bonuses for this {@code ItemDefinition}.
     * @param twoHanded The flag that determines if this {@code ItemDefinition}
     *        is two-handed.
     * @param fullHelm The flag that determines if this {@code ItemDefinition}
     *        is a full helmet.
     * @param platebody The flag that determines if this {@code ItemDefinition}
     *        is a platebody.
     * @param tradeable The flag that determines if this {@code ItemDefinition}
     *        is tradeable.
     */
    public ItemDefinition(int id, String name, String examine, int equipmentSlot, boolean noteable, boolean stackable, int specialValue, int generalValue, int lowAlchValue,
        int highAlchValue, double weight, int[] bonus, boolean twoHanded, boolean fullHelm, boolean platebody, boolean tradeable) {
        this.id = id;
        this.name = name;
    ...
    /**
     * @return The identifier for {@this {@code ItemDefinition}.
     */
    public int getId() {
        return id;
    }
    ...
    /**
     * @return The name of {@this {@code ItemDefinition}.
     */
    ...
    /**
     * @return The description of {@this {@code ItemDefinition}.
     */
    ...
    /**
     * @return The equipment slot of {@this {@code ItemDefinition}.
     */
    ...
    /**
     * @return {@code true} if {@this {@code ItemDefinition} is noteable,
    ...
    /**
     * @return {@code true} if {@this {@code ItemDefinition} is stackable,
     *         {@code false} otherwise.
     */
    ...
    /**
     * @return The special store value of {@this {@code ItemDefinition}.
     */
    ...
    /**
     * @return The general store value of {@this {@code ItemDefinition}.
     */
    ...
    /**
     * @return The low alchemy value of {@this {@code ItemDefinition}.
     */
    ...
    /**
     * @return The high alchemy value of {@this {@code ItemDefinition}.
     */
    ...
    /**
     * @return The weight value of {@this {@code ItemDefinition}.
     */
    ...
    /**
     * @return The {@link ImmutableList} of bonuses for {@this
     *         {@code ItemDefinition}.
     */
    ...
    /**
     * @return {@code true} if {@this {@code ItemDefinition} is two-handed,
     *         {@code false} otherwise.
     */
    ...
    /**
     * @return {@code true} if {@this {@code ItemDefinition} is a full helmet,
     *         {@code false} otherwise.
     */
    ...
    /**
     * @return {@code true} if {@this {@code ItemDefinition} is a platebody,
     *         {@code false} otherwise.
     */
    ...
    /**
     * @return {@code true} if {@this {@code ItemDefinition} is tradable,
     *         {@code false} otherwise.
     */
