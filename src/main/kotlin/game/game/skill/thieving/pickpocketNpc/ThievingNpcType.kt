 ...
 * @author lare96
 */
enum class ThievingNpcType(val level: Int,
                           val xp: Double,
                           val master: Int,
                           val stun: Long,
                           val damage: IntRange,
    ...
    WARRIOR(level = 25,
            ...
            stun = 5,
            damage = 1..2,
            names = listOf("Warrior woman", "Warrior"),
    ...
    KNIGHT_OF_ARDOUGNE(level = 55,
                       ...
                       stun = 6,
                       damage = 3..5,
                       names = listOf("Knight of Ardougne"),
    ...
    GNOME(level = 75,
          ...
          stun = 5,
          damage = 1..1,
          names = listOf("Gnome", "Gnome woman"),
          drops = DropTableHandler.createSimple {
    ...
    companion object {
        ...
        /**
         * Mappings of all names to [ThievingNpcType] instances.
         */
        val NAME_TO_NPC: ImmutableMap<String, ThievingNpcType> = run {
            val builder = ImmutableMap.builder<String, ThievingNpcType>()
            for (next in values()) {
