...
enum class SilverJewelleryTable(val mouldWidgetId: Int,
    ...
    SARADOMIN_SYMBOL(mouldWidgetId = 15445,
                     mouldId = 1599,
                     jewelleryItem = JewelleryItem(1714, 16, 50.0)),
    SILVER_SICKLE(mouldWidgetId = 15459,
                  mouldId = 2976,
                  jewelleryItem = JewelleryItem(2961, 18, 50.0)),
    TIARA(mouldWidgetId = 15473,
          mouldId = 5523,
          jewelleryItem = JewelleryItem(5525, 23, 52.5)),
    DEMONIC_SIGIL(mouldWidgetId = 15481,
                  mouldId = 6747,
                  jewelleryItem = JewelleryItem(6748, 30, 50.0)),
    ZAMORAK_SYMBOL(mouldWidgetId = 15452,
                   mouldId = 1594,
                   jewelleryItem = JewelleryItem(1720, 17, 50.0)),
    LIGHTNING_ROD(mouldWidgetId = 15466,
                  mouldId = 4200,
                  jewelleryItem = JewelleryItem(4201, 20, 50.0)),
    SILVTHRILL_ROD(mouldWidgetId = 18519,
                   mouldId = 7649,
                   jewelleryItem = JewelleryItem(7620, 25, 55.0));
