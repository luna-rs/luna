...
enum class AgilityCourse(val level: Int, val bonus: Double, val obstacles: Set<AgilityObstacle>) {
    GNOME_STRONGHOLD(
        ...
        bonus = 50.0,
        obstacles = setOf(
            GNOME_LOG_BALANCE, GNOME_OBSTACLE_NET, GNOME_TREE_BRANCH,
    ...
    BARBARIAN_OUTPOST(
        ...
        bonus = 46.3,
        obstacles = setOf(
            BARBARIAN_ROPESWING, BARBARIAN_LOG_BALANCE, BARBARIAN_OBSTACLE_NET,
    ...
    WILDERNESS(
        ...
        bonus = 497.9,
        obstacles = setOf(
            WILDERNESS_OBSTACLE_PIPE, WILDERNESS_ROPESWING, WILDERNESS_STEPPING_STONE,
