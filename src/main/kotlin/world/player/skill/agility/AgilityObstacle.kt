 ...
 */
enum class AgilityObstacle(
    val startIf: Player.() -> Boolean = { true },
    val xp: Double,
    ...
    BARBARIAN_ROPESWING(
        startIf = { x == 2551 && y == 3554 },
        xp = 22.0
    ),
    BARBARIAN_LOG_BALANCE(
        startIf = { x == 2551 && y == 3546 },
        xp = 13.7
    ),
    BARBARIAN_OBSTACLE_NET(
        startIf = { x == 2539 && (y == 3545 || y == 3546) },
        xp = 8.2
    ),
    BARBARIAN_BALANCING_LEDGE(xp = 22.0),
    BARBARIAN_LADDER(
        startIf = { x == 2532 && y == 3546 },
        xp = 1.0
    ),
