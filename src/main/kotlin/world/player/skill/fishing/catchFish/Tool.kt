...
enum class Tool(val id: Int,
    ...
    SMALL_NET(id = 303,
              ...
              catchRate = 15,
              animation = 621,
              fish = listOf(SHRIMP, ANCHOVY)), // You cast out your net
    KARAMBWANJI_SMALL_NET(id = 303,
                          level = 5,
                          catchRate = 15,
                          animation = 621,
                          fish = listOf(SHRIMP, KARAMBWANJI)),
    FISHING_ROD(id = 307, // You cast our your line...
                level = 5,
                bait = 313,
                catchRate = 10,
                animation = 622,
                fish = listOf(SARDINE, HERRING, PIKE)), // TODO send dialogue message on no tool
    ...
    BIG_NET(id = 305,
            ...
            catchRate = 17,
            animation = 620,
            fish = listOf(MACKEREL, OYSTER, COD, BASS, CASKET, LEATHER_BOOTS, LEATHER_GLOVES, SEAWEED)), // You cast out your net
    FLY_FISHING_ROD(id = 309,
                    level = 20,
                    bait = 314,
                    catchRate = 10,
                    animation = 622,
                    fish = listOf(TROUT, SALMON)), // You cast out your line
    HARPOON(id = 311,
            level = 35,
            catchRate = 18,
            animation = 618,
