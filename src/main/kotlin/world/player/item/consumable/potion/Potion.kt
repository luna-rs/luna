...
import world.player.item.consumable.potion.PotionEffect
...
enum class Potion(val fourDose: Int,
    ...
    ZAMORAK_BREW(fourDose = 2450,
                 ...
                 twoDose = 191,
                 oneDose = 193) {
        override fun effect(plr: Player) {
            plr.onZamorakBrew()
        }
    },
    ...
    AGILITY_POTION(fourDose = 3032,
                   ...
                   oneDose = 3038) {
        override fun effect(plr: Player) {
            plr.onSkillPotion(SKILL_AGILITY)
        }
    },
    FISHING_POTION(fourDose = 2438,
                   ...
                   oneDose = 155) {
        override fun effect(plr: Player) {
            plr.onSkillPotion(SKILL_FISHING)
        }
    },
    RANGING_POTION(fourDose = 2444,
                   ...
                   oneDose = 173) {
        override fun effect(plr: Player) {
            plr.onCombatPotion(SKILL_RANGED)
        }
    },
    MAGIC_POTION(fourDose = 3040,
                 ...
                 oneDose = 3046) {
        override fun effect(plr: Player) {
            plr.onCombatPotion(SKILL_MAGIC)
        }
    },
    DEFENCE_POTION(fourDose = 2432,
                   ...
                   oneDose = 137) {
        override fun effect(plr: Player) {
            plr.onCombatPotion(SKILL_DEFENCE)
        }
    },
    STRENGTH_POTION(fourDose = 113,
                    ...
                    oneDose = 119) {
        override fun effect(plr: Player) {
            plr.onCombatPotion(SKILL_STRENGTH)
        }
    },
    ...
    ATTACK_POTION(fourDose = 2428,
                  ...
                  oneDose = 125) {
        override fun effect(plr: Player) {
            plr.onCombatPotion(SKILL_ATTACK)
        }
    },
    SUPER_DEFENCE(fourDose = 2442,
                  ...
                  oneDose = 167) {
        override fun effect(plr: Player) {
            plr.onCombatPotion(SKILL_DEFENCE, true)
        }
    },
    SUPER_ATTACK(fourDose = 2436,
                 ...
                 oneDose = 149) {
        override fun effect(plr: Player) {
            plr.onCombatPotion(SKILL_ATTACK, true)
        }
    },
    SUPER_STRENGTH(fourDose = 2440,
                   ...
                   oneDose = 161) {
        override fun effect(plr: Player) {
            plr.onCombatPotion(SKILL_STRENGTH, true)
        }
    },
    ...
    ANTIPOISON_POTION(fourDose = 2446,
                      ...
                      oneDose = 179) {
        override fun effect(plr: Player) {
            plr.onAntipoison(ANTIPOISON_POTION, 150)
        }
    },
    SUPER_ANTIPOISON(fourDose = 2448,
                     ...
                     oneDose = 185) {
        override fun effect(plr: Player) {
            plr.onAntipoison(SUPER_ANTIPOISON, 600)
        }
    },
    ANTIDOTE_PLUS(fourDose = 5943,
                  ...
                  oneDose = 5949) {
        override fun effect(plr: Player) {
            plr.onAntipoison(ANTIDOTE_PLUS, 1000)
        }
    },
    ANTIDOTE_PLUS_PLUS(fourDose = 5952,
                       ...
                       oneDose = 5958) {
        override fun effect(plr: Player) {
            plr.onAntipoison(ANTIDOTE_PLUS_PLUS, 1200)
        }
    },
