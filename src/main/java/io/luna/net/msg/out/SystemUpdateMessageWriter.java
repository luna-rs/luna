...
/**
 * A {@link MessageWriter} implementation that displays a system update message. This packet does not
 * log the player out or terminate the server.
 *
 * @author lare96 <http://github.com/lare96>
 */
public class SystemUpdateMessageWriter extends MessageWriter {
