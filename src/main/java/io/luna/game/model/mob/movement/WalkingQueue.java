...
public final class WalkingQueue {
     ...
     * a destination-based path generated by the pathfinder, use {@link WalkingNavigator#navigate(Position, boolean)} instead.
     *
    ...
    private boolean decrementRunEnergy() {
        ...
        double energyReduction = 0.117 * 3 * Math
                .pow(Math.E, 0.0037725887222397812376689284858327062723020005374410 * totalWeight);
