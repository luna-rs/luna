...
/**
 * An {@link Action} implementation that details Actions related to skills. Not meant to be inherited from directly, one
 * of the following subclasses should be used instead
 * <ul>
 *     <li> DestructionSkillAction</li>
 *     <p>
 ...
 *     <p>
 *     For skills that require a harvesting formula (for example: woodcutting, fishing, mining).
 *     <li>ProducingSkillAction</li>
 *     <p>
...
public abstract class SkillAction extends Action<Player> {
    ...
    /**
     * Function called after every delay if the mob this action is for is active.
     */
