 ...
 */
fun Player.onAntipoison(immunityDuration: Int = -1) {}

/**
 * Invoked when a prayer potion is sipped.
 */
fun Player.onPrayerPotion() {
    val prayer = skill(SKILL_PRAYER)
 ...
 */
fun Player.onSkillPotion(skillId: Int) {
 ...
 */
fun Player.onEnergyPotion(superPotion: Boolean) {
 ...
 */
fun Player.onRestorePotion(superPotion: Boolean) {
 ...
 */
fun Player.onAntifirePotion() {
}

/**
 * Invoked when a combat skill potion is sipped.
 */
fun Player.onCombatPotion(skillId: Int, superPotion: Boolean = false) {
